...
import { TitleCol,ValueCol,Row,MobileRow,MiniValueCol,IconWrap, MiniTitleCol, Product ,TopRow} from './ProductsItem.styled'
  ...
  return (
    <Product>
     <TopRow> <Row>
        ...
        <ValueCol><p>{product.title}</p></ValueCol>
      </Row>
      <Row>
        <TitleCol>Category</TitleCol>
        <ValueCol ><p>{product.category}</p></ValueCol>
      </Row></TopRow>
      ...
      <MobileRow>
        <MiniValueCol><p>{product.calories}</p></MiniValueCol>
        <MiniValueCol><p>{product.amount}</p></MiniValueCol>
        <MiniValueCol>
          <Status>
    ...
    <IconWrap>  <Icon onClick={handleProductDelete}
            name="delete"

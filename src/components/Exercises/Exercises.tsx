...
import bg from '../../assets/images/ImgForWelcomePage/imgForWelcomePage.jpg';
...
const responce = apiService({
     method: 'get', url: `/exercises/${filter}?page=${page}&limit=${limit}`
   });
   setIsLoading(true);
   responce
